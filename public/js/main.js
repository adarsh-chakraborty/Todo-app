	...
	if (todoData.length > 0) {
		...
		for ([index, todo] of todoData.entries()) {
			if (todo.isCompleted) {
				// if is completed
				html += `
                <div class="bg-green-300 rounded-md shadow-lg p-2">
                <div class="flex justify-between px-2">
                    <div class="w-64 font-poppins">
                        ${todo.todo}
                    </div>
                    <div class="flex space-x-1 text-green-900 items-center">
                        <div id="undocompleteTodo" onClick="undocompleteTodo(${index});" class="cursor-pointer">
            ...
            <div class="bg-gray-300 rounded-md shadow-lg p-2">
                    <div class="flex justify-between px-2">
                        ...
                        <div class="flex space-x-1 text-gray-800 items-center">
                            <div id="completeTodo" onClick="completeTodo(${index});" class="cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
